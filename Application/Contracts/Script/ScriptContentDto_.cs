...
{
    public class ScriptContentDto_V1
    {
        [JsonPropertyName("id")]
        ...
        public RenderInstructionDto_V1? RenderInstructions { get; set; }

        [JsonPropertyName("scenes")]
        public List<SceneDto_V1> Scenes { get; set; } = new();

        [JsonPropertyName("thumbnail")]
        public ThumbnailDto? Thumbnail { get; set; }

        [JsonPropertyName("metadata")]
        public MetadataDto_V1? Metadata { get; set; }

        [JsonPropertyName("youtube")]
        public YoutubeDto_V1? Youtube { get; set; }
        ...
        public ScriptRenderInfo_V1? Render { get; set; }
    }

    public class ScriptVoiceDto_V1
    {
    ...
    public class RenderInstructionDto_V1
    {
        ...
        public SoundMixDto_V1? SoundMix { get; set; }
    }

    public class SoundMixDto_V1
    {
    ...
    public class SceneDto_V1
    {
        ...
        public List<SubtitleDto_V1> Subtitles { get; set; } = new();
    ...
    public class YoutubeDto_V1
    {
        ...
        public UploadPolicyDto_V1? UploadPolicy { get; set; }
    }

    public class UploadPolicyDto_V1
    {
    ...
    public class PolicyReviewDto_V1
    {
    ...
    /// </summary>
    public class ScriptRenderInfo_V1
    {
