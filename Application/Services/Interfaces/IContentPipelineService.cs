...
namespace Application.Services.Interfaces
{
    public interface IContentPipelineService
    {
        ...
        Task CancelRunAsync(int userId, int runId, CancellationToken ct);
        ...
        Task ApproveRunAsync(int userId, int runId, CancellationToken ct);
        Task<string> RegenerateSceneImageAsync(int runId, int sceneNumber, int? beatIndex, string? imagePath, CancellationToken ct);
    }
}
