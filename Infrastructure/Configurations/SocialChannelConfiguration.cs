...
{
    public sealed class SocialChannelConfiguration : BaseEntityConfiguration<SocialChannel>, IEntityTypeConfiguration<SocialChannel>
    {
        public override void Configure(EntityTypeBuilder<SocialChannel> b)
        {
            base.Configure(b);
